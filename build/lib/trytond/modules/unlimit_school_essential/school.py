...
class SchoolYearSchoolProduct(ModelSQL):
    'school.year-school.product'
    __name__ = 'school.year-school.product'
    year = fields.Many2One('school.year', 'Origin')
    product = fields.Many2One('school.product', 'Target')
...
class SchoolYear(Workflow, ModelSQL, ModelView):
    ...
    enrollment2 = fields.One2One('school.year-school.product', 'year', 'product',
